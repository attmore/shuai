...
public final class IOUtils {
     ...
     * @param stream
     * @return
     * @see {@link #writeStream(String, java.io.InputStream, boolean)}
     */
     ...
     * @return return true
     * @throws java.io.IOException if an error occurs while operator FileOutputStream
     */
     ...
     * @param stream
     * @return
     * @see {@link #writeStream(java.io.File, java.io.InputStream, boolean)}
     */
