...
public abstract class ReflectionUtils {
     ...
     * twice, unless excluded by a {@link com.menghuoapp.utils.ReflectionUtils.MethodFilter}.
     *
     * @param clazz class to start looking at
     * @param mc    the callback to invoke for each method
     * @see #doWithMethods(Class, com.menghuoapp.utils.ReflectionUtils.MethodCallback, com.menghuoapp.utils.ReflectionUtils.MethodFilter)
     */
     ...
     * <p>The same named method occurring on subclass and superclass will appear
     * twice, unless excluded by the specified {@link com.menghuoapp.utils.ReflectionUtils.MethodFilter}.
     *
     * @param clazz class to start looking at
     * @param mc    the callback to invoke for each method
